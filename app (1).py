...
# ==========================================
# 3. SIDEBAR: PROJECT INTAKE FORM (FIXED STRUCUTRE)
# ==========================================
...
# Attach widgets directly to the container object instead of st.sidebar
...
p_deadline = intake_form.date_input("Client Deadline *", min_value=datetime.today())
